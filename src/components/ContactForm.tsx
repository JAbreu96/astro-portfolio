...
const ContactForm = () => {
  ...
  return (<section
    id="contact"
    className="h-fit font-mono flex flex-col items-center mt-48 w-full mb-48"
  >
    ...
    >
      ...
      <textarea className="w-5/6 sm:w-1/2 text-black" id="message" name="message" required></textarea>
